...
locationBtn.addEventListener('click', function (event) {
  ...
  locationLoader.style.diplay = 'block';

  navigator.geolocation.getCurrentPosition(function (position) {
    locationBtn.style.display = 'inline';
    locationLoader.style.diplay = 'none';
    fetchedLocation = {lat: position.coords.latitude, lng: 0};
    locationInput.value = 'In Philly';
...
// polyfill to handle browsers that (kinda) support accessing the camera, but not through the modern API
...
function openCreatePostModal() {
  ...
  // If we wanted to unregister our serviceWorker
...
function closeCreatePostModal() {
  ...
  captureButton.style.dislpay = 'inline';
