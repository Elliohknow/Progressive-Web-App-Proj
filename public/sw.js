...
var STATIC_FILES = [
  ...
  '/src/css/app.css',
  '/src/css/feed.css',
  '/src/images/druid-landscape.jpg',
  '/src/images/druid-landscape-sm.jpg',
...
self.addEventListener('fetch', function (event) {
  ...
  } else if (isInArray(event.request.url, STATIC_FILES)) { // Check to see if request url is part of the static_files array
    event.respondWith(
...
//     console.log(err);
//   });
// can't use the AJAX code below in service workers, need to use fetch api
// var xhr = new XMLHttpRequest();
// xhr.open('GET', 'https://httpbin.prg/ip');
...
//   },
//   mode: 'cors', // OR 'no-cors' if we want to hide the data from the client
